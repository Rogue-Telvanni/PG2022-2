...
TextRenderer::TextRenderer(float width, float height, Shader *shader)
{
	...
	TextShader->Use();
	GLint projLoc = glGetUniformLocation(TextShader->ID, "projection");
...
void TextRenderer::RenderText(std::string text, float x, float y, float scale, glm::vec3 color)
{
    ...
    this->TextShader->Use();
    this->TextShader->setVec3("textColor", color.r, color.g, color.b);
